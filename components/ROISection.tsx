      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold mb-8 font-[family-name:var(--font-plus-jakarta-sans)] leading-tight">
              See Exactly How Fast You <span className="text-[#5ab8b4]">Recover Your Investment</span>
            </h2>

            <div className="space-y-8 mb-12">
              <div className="border-l-4 border-[#5ab8b4] pl-6 py-1">
                <p className="text-lg text-gray-400 mb-1 font-[family-name:var(--font-poppins)]">Manufacturing clients save:</p>
                <p className="text-3xl font-bold font-[family-name:var(--font-plus-jakarta-sans)]">₹15–20L <span className="text-lg font-normal text-gray-500">/ year in labor</span></p>
              </div>
              <div className="border-l-4 border-[#5ab8b4] pl-6 py-1">
                <p className="text-lg text-gray-400 mb-1 font-[family-name:var(--font-poppins)]">Avoid losses of:</p>
                <p className="text-3xl font-bold font-[family-name:var(--font-plus-jakarta-sans)]">₹10–15L <span className="text-lg font-normal text-gray-500">/ year in injury/downtime</span></p>
              </div>
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white/5 p-6 rounded-xl border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors">
                  <p className="text-4xl font-bold text-[#5ab8b4] mb-2">50–60%</p>
                  <p className="text-sm text-gray-300 font-[family-name:var(--font-poppins)]">reduction in material movement cost</p>
                </div>
                <div className="bg-white/5 p-6 rounded-xl border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors">
                  <p className="text-4xl font-bold text-[#5ab8b4] mb-2">30–40%</p>
          ...
          <div className="bg-gradient-to-br from-white/10 to-white/5 p-10 rounded-3xl border border-white/10 backdrop-blur-md shadow-2xl">
            <div className="text-center mb-10">
              <p className="text-2xl font-bold mb-4 font-[family-name:var(--font-plus-jakarta-sans)]">
                Your robot pays for itself in <br /><span className="text-[#5ab8b4] text-3xl">8–12 months</span>
              </p>
            ...
            {/* Enhanced Bar Chart */}
            <div className="flex items-end justify-center gap-12 h-80 pt-8 border-b border-white/10 pb-4">
              <div className="w-32 flex flex-col items-center gap-3 group">
                ...
                <div className="w-full bg-[#5ab8b4] h-32 rounded-t-xl relative shadow-[0_0_20px_rgba(90,184,180,0.3)] group-hover:shadow-[0_0_30px_rgba(90,184,180,0.5)] transition-shadow">
                  <div className="absolute bottom-4 w-full text-center text-sm font-bold text-black/70">Goat</div>
                </div>
                <p className="text-base font-bold text-white">Goat Robotics</p>
              </div>
              <div className="w-32 flex flex-col items-center gap-3 group">
                ...
                <div className="w-full bg-gray-700 h-72 rounded-t-xl relative opacity-80 group-hover:opacity-100 transition-opacity">
                  <div className="absolute bottom-4 w-full text-center text-sm font-bold text-white/50">Others</div>
                </div>
                <p className="text-base font-medium text-gray-400">Global Brands</p>
              </div>
            </div>
            <p className="text-center text-xs text-gray-500 mt-6 uppercase tracking-widest font-semibold">Payback Period (Lower is Better)</p>
          </div>
        </div>
      </div>
    </section>
